...
![Watchers](https://img.shields.io/github/watchers/yHUJibXnPx/make-sing-box-envs-nanopir3s-armbian) ![Stars](https://img.shields.io/github/stars/yHUJibXnPx/make-sing-box-envs-nanopir3s-armbian) ![Forks](https://img.shields.io/github/forks/yHUJibXnPx/make-sing-box-envs-nanopir3s-armbian) ![Vistors](https://visitor-badge.laobi.icu/badge?page_id=yHUJibXnPx.make-sing-box-envs-nanopir3s-armbian) ![LICENSE](https://img.shields.io/badge/license-MIT-green.svg)
<!-- <a href="https://star-history.com/#yHUJibXnPx/make-sing-box-envs-nanopir3s-armbian&Date">
  <picture>
    ...
    <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=yHUJibXnPx/make-sing-box-envs-nanopir3s-armbian&type=Date" />
  </picture>
</a> -->
...
4. 安装完成后，将生成配置文件与可执行二进制：
   ...
   $HOME/Desktop/sing-boxs
    ...
    │   ├── ui
    │   └── ui.zip
    ├── sing-box-1.15.0-alpha.4-linux-arm64.tar.gz
    ├── sing-box-start.sh
    ├── subs-fix.py
    └── temp_config.json
   ```
